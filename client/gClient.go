...
func AskingDateTime(ctx context.Context, m protoapi.RandomClient) (*protoapi.GetDateResponse, error) {
	request := &protoapi.GetDateRequest{
...
func AskPass(ctx context.Context, m protoapi.RandomClient, seed int64, length int64) (*protoapi.GetRandomPassResponse, error) {
	request := &protoapi.GetRandomPassRequest{
		Seed:   seed,
		Length: length,
	}
...
func AskRandom(ctx context.Context, m protoapi.RandomClient, seed int64, place int64) (*protoapi.GetRandomIntResponse, error) {
	request := &protoapi.GetRandomIntRequest{
		Seed:  seed,
		Place: place,
	}

	return m.GetRandomInt(ctx, request)
}
